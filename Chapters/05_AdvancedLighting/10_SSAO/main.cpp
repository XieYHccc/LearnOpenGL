...
{
    // setup glfw and glad
    GlfwWrapper::Get().Init("05_10_SSAO", SCR_WIDTH, SCR_HEIGHT);
    ...
    // -------------------------
    Shader shaderGeometryPass("ssao_gbuffer.vs", "ssao_gbuffer.fs");
    ...
    // load models
    // -----------
    Model backpack(FileSystem::GetAssetPath("resources/objects/backpack/backpack.obj"));
