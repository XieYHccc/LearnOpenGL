...
{
    // setup glfw and glad
    GlfwWrapper::Get().Init("04_03_FrameBuffers", SCR_WIDTH, SCR_HEIGHT);
    ...
    // depth and stencil render buffers
    unsigned int rbo;
    ...
    // load textures
    // -------------
    unsigned int cubeTexture  = loadTexture(FileSystem::GetAssetPath("resources/textures/container.jpg").c_str());
